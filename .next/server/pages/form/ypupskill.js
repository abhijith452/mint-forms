...
/* harmony import */ var _utils_getStateList__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(8594);
/* harmony import */ var _utils_getStateList__WEBPACK_IMPORTED_MODULE_14___default = /*#__PURE__*/__webpack_require__.n(_utils_getStateList__WEBPACK_IMPORTED_MODULE_14__);
...
const Form = (props)=>{
    ...
    let schema = yup__WEBPACK_IMPORTED_MODULE_15__.object().shape({
        ...
        institute: yup__WEBPACK_IMPORTED_MODULE_15__.string(),
        type: yup__WEBPACK_IMPORTED_MODULE_15__.string().required(),
        field: yup__WEBPACK_IMPORTED_MODULE_15__.string(),
        ...
        section: yup__WEBPACK_IMPORTED_MODULE_15__.string().when("ieeeMember", {
            is: "Yes",
            then: yup__WEBPACK_IMPORTED_MODULE_15__.string().required()
        })
    });
    ...
    const handleUpload = async (values)=>{
        ...
        try {
            ...
            const res = await axios__WEBPACK_IMPORTED_MODULE_3___default().post("/api/form/addresponse?formId=ypupskill", formData, {
                headers: {
                                ...
                                children: ({ values , errors , handleSubmit , setFieldValue  })=>/*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
                                        children: [
                                            ...
                                            /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(_UI_Components_FormSelect__WEBPACK_IMPORTED_MODULE_12__/* ["default"] */ .Z, {
                                                label: "State *",
                                                options: (_utils_getStateList__WEBPACK_IMPORTED_MODULE_14___default()),
                                                value: {
                                                    label: values.state,
                                                    value: values.state
                                                },
                                            ...
                                            /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(_UI_Components_FormOptions__WEBPACK_IMPORTED_MODULE_4__/* ["default"] */ .Z, {
                                                ...
                                                errors: (0,formik__WEBPACK_IMPORTED_MODULE_2__.getIn)(errors, "type") !== undefined ? (0,formik__WEBPACK_IMPORTED_MODULE_2__.getIn)(errors, "type") : ""
                                            }),
                                            /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(_UI_Components_FormOptions__WEBPACK_IMPORTED_MODULE_4__/* ["default"] */ .Z, {
...
var __webpack_exports__ = __webpack_require__.X(0, [427,174,704,834], () => (__webpack_exec__(6662)));
